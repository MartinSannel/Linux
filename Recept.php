...
echo '<html>
      ...
      <a href="GurkIndex.html"><div style="position: absolute; height: 130px; width: 100px; top: 0%; left: 5.2%">  </div></a>
       ...
       <div class="rubrik">
         <a href="Recept.php" style="color: orange; "><h1> StroggeBloggen </h1></a>
       </div>';
...
echo '<div id="navbar">
        <div class="topnav" id="myTopnav">
        	<a href="index.php" style="margin-left: 20%">Startsida</a>
			    <a href="Recept.php" class="active">Recept</a>
	...
	<div class="start">
      <article>
        ...
        <h2> Här delar du alla dina smarriga stroggerecept </h2>';

        if(isset($_SESSION['username'])){
           echo '
        <form action="InskickRecept.php" method="POST">
...
echo '
        ...
        <form action="HamtaStroggeRecept.php" method="POST">
